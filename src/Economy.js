      ...
      <div className = "economy-page">
        <div className = "economy-information">
            <div className ="p-tags">
                ...
                <p>Tax Builds revolve around using tax cards, which are Raise Tax, Lottery and Collect. I find that Raise Taxes is the most consistent because you can stack the effects. Make sure you have a lot of houses and a tax office to have a high base tax. A side effect going this path is a high population for more soldiers.</p>
                <img className = "guide-image" src={require("./resources/raise_tax.png")} alt ={""}/>
                <img className = "guide-image" src={require("./resources/lottery.png")} alt ={""}/>
                <img className = "guide-image" src={require("./resources/collect.png")} alt ={""}/> 
                ...
                <img className = "guide-image" src={require("./resources/experiments.png")} alt ={""}/>
                <img className = "guide-image" src={require("./resources/dice.png")} alt ={""}/>
                <img className = "guide-image" src={require("./resources/assistance.png")} alt ={""}/>
                <br/><div className = "line-divider"></div>
                ...
                <img className = "guide-image" src={require("./resources/bounty_hunt.png")} alt ={""}/>
                <img className = "guide-image" src={require("./resources/tannery.png")} alt ={""}/>
                <br/><div className = "line-divider"></div>
                ...
                <img className = "guide-image" src={require("./resources/farm.png")} alt ={""}/>
                <img className = "guide-image" src={require("./resources/granary.png")} alt ={""}/>
                <br/><div className = "line-divider"></div>
                ...
                <img className = "guide-image" src={require("./resources/cheese_market.png")} alt ={""}/>
                <br/><div className = "line-divider"></div>
