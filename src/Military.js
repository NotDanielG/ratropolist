        ...
        <div className = "military-information">
          <div className = "p-tags">
            <div className="titles">Ratropolis Metropolis</div>
                ...
                <img className = "military-image" src={require("./resources/breed.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/warren.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/guards.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/shieldrat.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/pikerat.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/druid.png")} alt ={""}/>
            <br/>
            ...
            <div className="titles">Super Soldier</div>
                ...
                <img className = "military-image" src={require("./resources/barracks.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/labor_command.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/visit.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/d-rex.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/royal_guard.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/tavern.png")} alt ={""}/>
            <br/>
            <div className = "line-divider"></div>
            ...
            <div className="titles">Crossbows</div>
                ...
                <img className = "military-image" src={require("./resources/crossbowrat.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/guardian.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/medic.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/druid.png")} alt ={""}/>
                <img className = "military-image" src={require("./resources/pikerat.png")} alt ={""}/>
            <br/>
            <div className = "line-divider"></div>
