      ...
      <div className = "about-page">
        ...
        <div className = "about-information">
          <div className = "p-tags">
            ...
            <p>The site has two primary functions. The first primary function is to serve as a resource for Ratropolis related material. The second is to familiarize myself with ReactJS. All code is public <a className ="official-links" href = "https://github.com/NotDanielG/Ratropolist">here.</a></p>
